...
// import PowerMenu from "../customs/powermenu.js"
    ...
    start_widget: Widget.Box({
      children: [
        ...
        RoundedAngleEnd("topright", {class_name: "angle"})
			...
			// 		hexpand: true,
			// 		children: [
			// 				RoundedAngleEnd("topleft", {class_name: "angle", click_through: true}), // Left angle
			// 				center, // Center widget
			// 				RoundedAngleEnd("topright", {class_name: "angle"}) // Right angle
			// 		]
			// }),
