...
# default is used.
# Type: Directory
c.downloads.location.directory = '~/dwls'
...
c.tabs.show_switching_delay =15000
...
# Type: Font
c.fonts.prompts = 'IBM Plex Sans'

# Font used in the statusbar.
# Type: Font
c.fonts.statusbar = '11pt "IBM Plex Sans Mono"'
