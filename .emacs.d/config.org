...
(global-set-key (kbd "<f11>") 'olivetti-mode)
#+END_SRC
* Git.
#+BEGIN_SRC emacs-lisp
...
(pretty-hydra-define hydra-org-capture
  ...
  ("Org-roam commands"
   (("c" org-roam-capture "Capture to Org Roam")
	...
	("s" org-roam-server-mode "Toggle Org Roam server mode")
...
(defvar custom-daily-agenda
  `(
	(tags-todo "TODO=\"TODO\"|DEADLINE>=\"<+1w>\"|SCHEDULED>=\"<+1w>\""
               ((org-agenda-span 'week)
                (org-agenda-start-on-weekday 1) ; Start the week on Monday
                (org-agenda-block-separator nil)
                (org-agenda-overriding-header "\nTODOs for the current week\n")))
...
(setq org-capture-templates
      `(
		("s" "Scheduled Task")
		("sa" "Priority" entry (file+headline "~/public/org/agenda/refill.org" "Priority")
         "** TODO [#A] %? %^G \n  SCHEDULED: %^t" :empty-lines 1)
		("sb" "Priority" entry (file+headline "~/public/org/agenda/refill.org" "Priority")
         "** TODO [#B] %? %^G \n  SCHEDULED: %^t" :empty-lines 1)
		("sc" "Priority" entry (file+headline "~/public/org/agenda/refill.org" "Priority")
         "** TODO [#C] %? %^G \n  SCHEDULED: %^t" :empty-lines 1)

		;; ("t" "TODO" entry (file+headline "~/.emacs.d/org/agenda/refill.org" "Tasks")
		;;  "** TODO %? %^G \n" :empty-lines 1)
		...
		("n" "Note" entry (file+headline "~/public/org/agenda/refill.org" "Notes")
		 "** %? %^G\n" :empty-lines 1)
		("j" "Journal" entry (file+datetree "~/public/org/agenda/journal.org")
		 "** %? %^G\nEntered on %U\n")
...
(use-package general
  ...
  (user/leader-keys
    ...
    "f b" '((lambda () (interactive)
              (find-file "~/webdev/blog/org/jpacheco.xyz.org")) 
  ...
  (user/leader-keys
	...
	"o p" '(open-post-org-files :wk "Open lisp files")
...
;; (global-set-key (kbd "C-x o") 'command-log-mode)
#+END_SRC
