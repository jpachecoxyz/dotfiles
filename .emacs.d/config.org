...
(setq org-tags-exclude-from-inheritance '("crypt"))     ; Prevent inheritance of "pass" tag

;; Automatically encrypt entries tagged with "pass" before saving
(add-hook 'before-save-hook. 'org-crypt-use-before-save-magic)

;; Optional: Add keybinding to manually encrypt entries
(define-key org-mode-map (kbd "C-c C-x C-e") 'org-encrypt-entries)
(define-key org-mode-map (kbd "C-c C-x C-d") 'org-decrypt-entries)
#+END_SRC
