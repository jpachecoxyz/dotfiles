...
(setq org-capture-templates
      `(
        ...
        ("i" "Ideas to my posts" entry (file+headline "~/webdev/jpachecoxyz.github.io/hugo/org/jpacheco.xyz.org" "Ideas:")
         "** TODO %?" :empty-lines 1)
...
See `org-capture-templates' for more information."
  (let* ((title (read-from-minibuffer "Post Title: "))          ; Prompt for the post title
         ...
         (tags (progn
                 ;; Refresh the buffer to ensure tags are updated
                 (org-refresh-tags)
                 (completing-read-multiple "Tags: " (org-get-buffer-tags)))))
    (mapconcat #'identity
               `(
                 ...
                 ,(concat ":TAGS: " (string-join tags ","))     ; Store tags in :TAGS: property
