...
(defcustom emacs-solo-enable-icomplete nil
  "Enable `emacs-solo-icomplete'."
  :type 'boolean
  :group 'emacs-solo)
...
(use-package icomplete
  ...
  :bind (:map icomplete-minibuffer-map
              ...
              ("ESC" . exit-minibuffer)) ;; So we can exit commands like `multi-file-replace-regexp-as-diff'
  :hook
...
(use-package emacs-solo-weather
  ...
  (setq emacs-solo-weather-city "H.Matamoros")
