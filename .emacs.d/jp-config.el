...
(use-package dired-rainbow
  ...
  (progn
    ...
    (dired-rainbow-define markdown "#ebdbb2" ("org" "etx" "info" "markdown" "md" "mkd" "nfo" "pod" "rst" "tex" "textfile" "txt")) ;; Light Background
    (dired-rainbow-define database "#8ec07c" ("xlsx" "xls" "csv" "accdb" "db" "mdb" "sqlite" "nc")) ;; Aqua
    (dired-rainbow-define media "#fe8019" ("mp3" "mp4" "MP3" "MP4" "avi" "mpeg" "mpg" "flv" "ogg" "mov" "mid" "midi" "wav" "aiff" "flac")) ;; Orange
...
(use-package general
  ...
  (user/leader-keys
	...
	"o -" '(treemacs-select-window :wk "Dired jump to current")
