...
(atom-one-dark-with-color-variables
  (custom-theme-set-faces
   ...
   ;; mode-line
   `(mode-line ((t (:background ,atom-one-dark-black :foreground ,atom-one-dark-silver :box (:color ,atom-one-dark-border :line-width 2)))))
   ...
   ;; vc-mode
   `(vc-diff-added ((t (:foreground ,atom-one-dark-green))))
   `(vc-diff-removed ((t (:foreground ,atom-one-dark-red-1))))
   ...
   ;; `(org-block-begin-line ((t (:background ,atom-one-dark-border))))
   `(org-block ((t (:background ,atom-one-dark-black))))
   ;; `(org-block-end-line ((t (:background ,atom-one-dark-border))))
