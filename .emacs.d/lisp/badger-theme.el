...
(badger/with-color-variables 
  (custom-theme-set-faces
   ...
   `(fringe ((t (:foreground ,badger-fg :background ,badger-bg))))
   ...
   `(font-lock-comment-face ((t (:foreground ,badger-charcoal :italic t))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,badger-charcoal :italic t))))
   ...
   ;; >>>>> git-gutter
   `(git-gutter:added ((t (:foreground ,badger-green :weight bold))))
   `(git-gutter:deleted ((t (:foreground ,badger-red :weight bold))))
   `(git-gutter:modified ((t (:foreground ,badger-orange :weight bold))))

   
   ;; >>>>> Org mode
   `(org-document-info-keyword ((t (:foreground ,badger-olive))))
   `(org-meta-line ((t (:foreground ,badger-olive))))
   ...
   `(org-block ((t (:background ,badger-code-block))))
   ...
   `(org-scheduled ((t (:foreground ,badger-green))))
   `(org-scheduled-previously ((t (:foreground ,badger-red))))
   `(org-scheduled-today ((t (:foreground ,badger-blue))))
   `(org-sexp-date ((t (:foreground ,badger-blue :underline t))))
   `(org-time-grid ((t (:foreground ,badger-orange))))
   ...
   ;; >>>>> rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((t (:foreground ,badger-blue))))
   `(rainbow-delimiters-depth-2-face ((t (:foreground ,badger-green))))
   `(rainbow-delimiters-depth-3-face ((t (:foreground ,badger-orange))))
   `(rainbow-delimiters-depth-4-face ((t (:foreground ,badger-teal))))
   `(rainbow-delimiters-depth-5-face ((t (:foreground ,badger-violet))))
   `(rainbow-delimiters-depth-6-face ((t (:foreground ,badger-orange))))
   `(rainbow-delimiters-depth-7-face ((t (:foreground ,badger-blue))))
   `(rainbow-delimiters-depth-8-face ((t (:foreground ,badger-green))))
   `(rainbow-delimiters-depth-9-face ((t (:foreground ,badger-orange))))
   `(rainbow-delimiters-depth-10-face ((t (:foreground ,badger-teal))))
   `(rainbow-delimiters-depth-11-face ((t (:foreground ,badger-violet))))
   `(rainbow-delimiters-depth-12-face ((t (:foreground ,badger-orange))))
   `(rainbow-delimiters-unmatched-face ((t (:foreground ,badger-red :weight bold))))

   ;; >>>>> lsp-ui
   `(lsp-ui-doc-header ((t (:background ,badger-bg+1 :foreground ,badger-fg))))
   `(lsp-ui-doc-background ((t (:background ,badger-bg :foreground ,badger-fg))))
   ))
