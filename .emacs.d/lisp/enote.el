...
(defcustom enote-frame-background-color "#1a1a1a"
  "User-defined background color for the frame."
  :type 'string
  :group 'frame-parameters)

(defcustom enote-frame-foreground-color "#ebdbb2"
...
(global-set-key (kbd "C-<f11>") 'manage-enote-frame)
(global-set-key (kbd "C-<f12>") 'enote--delete-note)
