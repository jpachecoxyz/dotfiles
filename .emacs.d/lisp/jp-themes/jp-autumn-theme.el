;;; jp-autumn-theme.el --- Legible dark theme with warm, varied colors (red, yellow, green, teal) -*- lexical-binding:t -*-
...
in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom jp-autumn-palette-overrides nil
    "Overrides for `jp-autumn-palette'.
...
further details)."
  ...
  (jp-themes-theme jp-autumn jp-autumn-palette jp-autumn-palette-overrides)

  (provide-theme 'jp-autumn))

;;; jp-autumn-theme.el ends here
