...
;;; jp-elea-dark-theme.el --- Legible dark theme with brown, magenta, and green colors -*- lexical-binding:t -*-
...
in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom jp-elea-dark-palette-overrides nil
    "Overrides for `jp-elea-dark-palette'.
...
further details)."
  ...
  (jp-themes-theme jp-elea-dark jp-elea-dark-palette jp-elea-dark-palette-overrides)

  (provide-theme 'jp-elea-dark))

;;; jp-elea-dark-theme.el ends here
