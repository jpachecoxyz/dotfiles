;;; jp-gruvbox-theme.el --- A retro-groove colour theme for Emacs -*- lexical-binding: t -*-
...
(gruvbox-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (gruvbox-dark0_hard      "#1c1c1c" "#1c1c1c")
 ...
 (custom-theme-set-variables 'jp-gruvbox
...
(provide-theme 'jp-gruvbox)

;; Local Variables:
;; eval: (when (fboundp 'rainbow-mode) (rainbow-mode +1))
;; End:

;;; jp-gruvbox-theme.el ends here
