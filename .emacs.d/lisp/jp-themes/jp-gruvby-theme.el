...
(defvar jp-gruvby-colors-alist
  (let* ((256color  (eq (display-color-cells (selected-frame)) 256))
         (colors `(("jp-gruvby-accent"   . "#8ec07c")
                   ...
                   ("jp-gruvby-bg-1"     . (if ,256color "color-234" "#222222"))
...
(jp-gruvby-with-color-variables
  (custom-theme-set-faces
   ...
   `(region ((t (:background ,jp-gruvby-accent :distant-foreground ,jp-gruvby-mono-2))))
   ...
   `(org-level-3 ((t (:foreground ,jp-gruvby-cyan :weight bold))))
   `(org-level-4 ((t (:foreground ,jp-gruvby-orange-1 :weight bold))))
   `(org-date ((t (:foreground ,jp-gruvby-cyan))))
   `(org-ellipsis ((t (:underline nil))))
   `(org-document-info ((t (:foreground ,jp-gruvby-cyan))))
   `(org-document-info-keyword ((t (:inherit org-meta-line :underline nil))))
   `(org-document-title ((t (:height 1.5 :foreground ,jp-gruvby-blue))))
   `(org-verbatim ((t (:foreground ,jp-gruvby-cyan :weight bold))))
