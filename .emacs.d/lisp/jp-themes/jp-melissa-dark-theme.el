;;; jp-melissa-dark-theme.el --- Legible dark theme with warm colors (yellow, red, green, cyan) -*- lexical-binding:t -*-

;; Copyright (C) 2022-2024  Free Software Foundation, Inc.

;; Author: Protesilaos Stavrou <info@protesilaos.com>
;; Maintainer: Protesilaos Stavrou <info@protesilaos.com>
;; URL: https://github.com/protesilaos/jp-themes
...
in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom jp-melissa-dark-palette-overrides nil
    "Overrides for `jp-melissa-dark-palette'.

Mirror the elements of the aforementioned palette, overriding
their value.

For overrides that are shared across all of the Ef themes,
refer to `jp-themes-common-palette-overrides'.
...
further details)."
  ...
  (jp-themes-theme jp-melissa-dark jp-melissa-dark-palette jp-melissa-dark-palette-overrides)

  (provide-theme 'jp-melissa-dark))

;;; jp-melissa-dark-theme.el ends here
