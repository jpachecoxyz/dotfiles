;;; jp-owl-theme.el --- Legible dark theme with blue, cyan, magenta and desaturated colors -*- lexical-binding:t -*-
...
in the palette and is associated with a HEX-VALUE.")
  ...
  (defcustom jp-owl-palette-overrides nil
    "Overrides for `jp-owl-palette'.
...
further details)."
  ...
  (jp-themes-theme jp-owl jp-owl-palette jp-owl-palette-overrides)

  (provide-theme 'jp-owl))

;;; jp-owl-theme.el ends here
