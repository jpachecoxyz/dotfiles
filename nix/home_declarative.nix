...

{
  ...
  home.file = {
    # Local.
    ".local" = {
        source = config.lib.file.mkOutOfStoreSymlink "/home/javier/.dotfiles/.local/";
        recursive = true;
    };
    # Configuration.
    ...
    # Bars
    ".config/ags" = {
        source = config.lib.file.mkOutOfStoreSymlink "/home/javier/.dotfiles/.config/ags/";
        recursive = true;
    };
    ...
    # Emacs
    ".emacs.d" = {
        source = config.lib.file.mkOutOfStoreSymlink "/home/javier/.dotfiles/.emacs.d/";
        recursive = true;
    };
    # Neovim
    ".config/nvim" = {
        source = config.lib.file.mkOutOfStoreSymlink "/home/javier/.dotfiles/.config/nvim/";
        recursive = true;
    };
  };
